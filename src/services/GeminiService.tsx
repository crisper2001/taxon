          ...
          properties: {
            ...
            features_used: {
              ...
              items: {
                type: Type.OBJECT,
                properties: {
                  id: { type: Type.STRING, description: "CRITICAL: For categorical features, this MUST be the specific state's ID (found inside the 'states' array). NEVER use the parent feature's ID." },
